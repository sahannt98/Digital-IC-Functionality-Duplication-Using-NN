    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if file_name == "":
                ...
                return render_template('uplodetextresult.html', massage=massage, status = "error_result")
                ...
                Mysql_Configure = MysqlConfigure(input_len,output_len)
                Mysql_Configure.PushData(X, Y, Table_Name)
                return render_template('uplodetextresult.html', massage="Created table", status = "correct_result")
        except Exception as e:
            return render_template('uplodetextresult.html', massage=e, status = "error_result")

    else:
        return render_template('uplodetext.html')
